...
BOT_TOKEN = "8495358409:AAExfmeUlb_cGgfio-au8lHAUkw-GYlsxK0"
SUPER_ADMIN_IDS = {7721881567, 7388690934, 6369229106}
VALUTE = "TON"
...
NOTIFICATION_CHAT_ID = -1003505289539
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        keyboard = [
            ...
            [InlineKeyboardButton(get_text(lang, "support_button"), url='https://t.me/NexusOtcSup')],
        ]
                ...
                if user_data[buyer_id].get('balance', 0) >= amount:
                    ...
                    await context.bot.send_message(
                        ...
                        reply_markup=InlineKeyboardMarkup([
                            ...
                            [InlineKeyboardButton(get_text(seller_lang, "contact_support_button"), url='https://t.me/NexusOtcSup')]
                        ])
                    )
